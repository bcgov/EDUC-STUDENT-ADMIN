...
curl -sX POST "https://$SOAM_KC/auth/admin/realms/$SOAM_KC_REALM_ID/roles" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer $TKN" \
  -d "{\"name\" : \"MANAGE_EAS_SESSIONS_PERMISSION\",\"description\" : \"Permission to manage EAS sessions\",\"composite\" : false,\"clientRole\" : false,\"containerId\" : \"$SOAM_KC_REALM_ID\"}"

echo
echo Retrieving MANAGE_EAS_SESSIONS_PERMISSION permission
manageSessionsPermissionJson=$(curl -sX GET "https://$SOAM_KC/auth/admin/realms/$SOAM_KC_REALM_ID/roles/MANAGE_EAS_SESSIONS_PERMISSION" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer $TKN")
...
curl -sX POST "https://$SOAM_KC/auth/admin/realms/$SOAM_KC_REALM_ID/roles" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer $TKN" \
  -d "{\"name\" : \"VIEW_EAS_STUDENT_PERMISSION\",\"description\" : \"Permission to view EAS student\",\"composite\" : false,\"clientRole\" : false,\"containerId\" : \"$SOAM_KC_REALM_ID\"}"

echo
echo Retrieving VIEW_EAS_STUDENT_PERMISSION permission
viewEasStudentsPermissionJson=$(curl -sX GET "https://$SOAM_KC/auth/admin/realms/$SOAM_KC_REALM_ID/roles/VIEW_EAS_STUDENT_PERMISSION" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer $TKN")

echo
echo Creating EDIT_EAS_STUDENT_PERMISSION permission
curl -sX POST "https://$SOAM_KC/auth/admin/realms/$SOAM_KC_REALM_ID/roles" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer $TKN" \
  -d "{\"name\" : \"EDIT_EAS_STUDENT_PERMISSION\",\"description\" : \"Permission to edit EAS student\",\"composite\" : false,\"clientRole\" : false,\"containerId\" : \"$SOAM_KC_REALM_ID\"}"

echo
echo Retrieving EDIT_EAS_STUDENT_PERMISSION permission
editEasStudentsPermissionJson=$(curl -sX GET "https://$SOAM_KC/auth/admin/realms/$SOAM_KC_REALM_ID/roles/EDIT_EAS_STUDENT_PERMISSION" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer $TKN")

echo
echo Creating EDIT_EAS_HISTORY_PERMISSION permission
curl -sX POST "https://$SOAM_KC/auth/admin/realms/$SOAM_KC_REALM_ID/roles" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer $TKN" \
  -d "{\"name\" : \"EDIT_EAS_HISTORY_PERMISSION\",\"description\" : \"Permission to edit EAS historical registrations\",\"composite\" : false,\"clientRole\" : false,\"containerId\" : \"$SOAM_KC_REALM_ID\"}"

echo
echo Retrieving EDIT_EAS_HISTORY_PERMISSION permission
editEasHistoryPermissionJson=$(curl -sX GET "https://$SOAM_KC/auth/admin/realms/$SOAM_KC_REALM_ID/roles/EDIT_EAS_HISTORY_PERMISSION" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer $TKN")

echo Creating MANAGE_EAS_ASSESSMENT_KEYS_PERMISSION permission
curl -sX POST "https://$SOAM_KC/auth/admin/realms/$SOAM_KC_REALM_ID/roles" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer $TKN" \
  -d "{\"name\" : \"MANAGE_EAS_ASSESSMENT_KEYS_PERMISSION\",\"description\" : \"Permission to manage EAS assessment keys\",\"composite\" : false,\"clientRole\" : false,\"containerId\" : \"$SOAM_KC_REALM_ID\"}"

echo
echo Retrieving MANAGE_EAS_ASSESSMENT_KEYS_PERMISSION permission
...
curl -sX POST "https://$SOAM_KC/auth/admin/realms/$SOAM_KC_REALM_ID/roles/EAS_ADMIN/composites" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer $TKN" \
  -d "[$manageSessionsPermissionJson, $viewEasStudentsPermissionJson, $editEasStudentsPermissionJson, $editEasHistoryPermissionJson, $manageEasAssessmentKeysPermissionJson]"
