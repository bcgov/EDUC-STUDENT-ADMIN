...
router.get('/district', passport.authenticate('jwt', {session: false}, undefined), utils.checkUserHasPermission(PERMISSION.VIEW_DISTRICT_PERMISSION), extendSession, getDistricts);
...
router.put('/authority/contact/:contactId', passport.authenticate('jwt', {session: false}, undefined), utils.hasPermissionToAddOrUpdateAuthority(), extendSession, updateAuthorityContact);

router.delete('/authority/contact/:independentAuthorityId/:contactId', passport.authenticate('jwt', {session: false}, undefined), utils.hasPermissionToAddOrUpdateAuthority(), extendSession, deleteAuthorityContact);

router.post('/authority', passport.authenticate('jwt', {session: false}, undefined), utils.hasPermissionToAddOrUpdateAuthority(), extendSession, addAuthority);

router.post('/authority/contact', passport.authenticate('jwt', {session: false}, undefined), utils.hasPermissionToAddOrUpdateAuthority(), extendSession, addAuthorityContact);
...
router.post('/school', passport.authenticate('jwt', {session: false}, undefined), utils.hasPermissionToAddOrUpdateSchool(), extendSession, addSchool);
...
router.post('/school/note', passport.authenticate('jwt', {session: false}, undefined), utils.hasPermissionToAddOrUpdateSchool(), extendSession, addNewSchoolNote);

router.put('/school/note/:noteId', passport.authenticate('jwt', {session: false}, undefined), utils.hasPermissionToAddOrUpdateSchool(), extendSession, updateSchoolNote);

router.delete('/school/note/:schoolId/:noteId', passport.authenticate('jwt', {session: false}, undefined), utils.hasPermissionToAddOrUpdateSchool(), extendSession, deleteSchoolNote);

router.delete('/school/contact/:schoolId/:contactId', passport.authenticate('jwt', {session: false}, undefined), utils.hasPermissionToAddOrUpdateSchool(), extendSession, deleteSchoolContact);

router.put('/school/contact/:contactId', passport.authenticate('jwt', {session: false}, undefined), utils.hasPermissionToAddOrUpdateSchool(), extendSession, updateSchoolContact);

router.post('/school/contact', passport.authenticate('jwt', {session: false}, undefined), utils.hasPermissionToAddOrUpdateSchool(), extendSession, addSchoolContact);
...
router.put('/school/:id', passport.authenticate('jwt', {session: false}, undefined), utils.hasPermissionToAddOrUpdateSchool(), extendSession, updateSchool);
...
router.post('/school/moveSchool', passport.authenticate('jwt', {session: false}, undefined), utils.hasPermissionToAddOrUpdateSchool(), extendSession, moveSchool);
...
router.post('/authority/note', passport.authenticate('jwt', {session: false}, undefined), utils.hasPermissionToAddOrUpdateAuthority(), extendSession, addNewAuthorityNote);

router.put('/authority/note/:noteId', passport.authenticate('jwt', {session: false}, undefined), utils.hasPermissionToAddOrUpdateAuthority(), extendSession, updateAuthorityNote);

router.delete('/authority/note/:independentAuthorityId/:noteId', passport.authenticate('jwt', {session: false}, undefined), utils.hasPermissionToAddOrUpdateAuthority(), extendSession, deleteAuthorityNote);

router.post('/authority/:id', passport.authenticate('jwt', {session: false}, undefined), utils.hasPermissionToAddOrUpdateAuthority(), extendSession, updateAuthority);
