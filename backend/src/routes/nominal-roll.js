...
const {createFedProvSchoolCode, postNominalRollFile, isBeingProcessed, startProcessing, getNominalRollStudentById, getNominalRollStudents, validateNominalRollStudentDemogData, updateNominalRollStudent, postNominalRollData, isDataPosted, validateNominalRollReportYear, downloadNominalRollReport} = require('../components/nominal-roll');
...
router.get('/report/:year', passport.authenticate('jwt', {session: false}, undefined), auth.isValidNominalRollUserToken, extendSession, validateNominalRollReportYear, downloadNominalRollReport);
