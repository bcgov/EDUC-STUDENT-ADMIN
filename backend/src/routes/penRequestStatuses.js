...
router.get('/requestStatuses', passport.authenticate('jwt', {session: false}, undefined), auth.isValidUserToken, utils.cacheMiddleware(), getRequestCodes('server:penRequest:statusCodeURL', 'penRequestStatusCodes'));
