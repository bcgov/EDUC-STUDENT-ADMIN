...
const { getActiveReportingPeriod, getPreviousReportingPeriod, updateReportingPeriod, getReportingSummary, getFilesetsPaginated, getDemographicStudentByPenIncomingFilesetIdAndSchoolId, getSummerReportingInsights, getSchoolYearReportingInsights, getSchoolSubmissionCounts } = require('../components/gdc/gdc');
...
router.get('/reporting-insights/:reportingPeriodID/Summer/:schoolCategory', passport.authenticate('jwt', {session: false}, undefined), permUtils.checkUserHasPermission(PERMISSION.VIEW_GRAD_DATA_COLLECTION_PERMISSION), extendSession, getSummerReportingInsights);
router.get('/reporting-insights/:reportingPeriodID/SchoolYear/:sdcCollectionID/:schoolCategory', passport.authenticate('jwt', {session: false}, undefined), permUtils.checkUserHasPermission(PERMISSION.VIEW_GRAD_DATA_COLLECTION_PERMISSION), extendSession, getSchoolYearReportingInsights);
