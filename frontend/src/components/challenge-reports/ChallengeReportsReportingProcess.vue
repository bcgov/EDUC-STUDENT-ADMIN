    ...
    <v-row no-gutters>
      <v-col cols="9">
        <ul>
          ...
          <li>
            Notify the Financial Management Division (EDUC.FundingAndAllocationUnit@gov.bc.ca) and the Independent Schools Group (faa.is@gov.bc.ca) that the challenge report is available for download.
          </li>
        </ul>
      </v-col>
    </v-row>
...
export default {
  name: 'ChallengeReportsReportingProcess',
