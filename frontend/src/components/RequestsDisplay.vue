      ...
      <v-card height="100%" width="100%"  style="background-color:#38598a;">
        ...
        <v-data-table
          ...
          <template v-slot:[penSlotName]="{ header }">
            ...
            <v-text-field id="pen-text-field" v-model="headerSearchParams[penName]" class="header-text" outlined dense clearable></v-text-field>
          </template>
...
export default {
  ...
  methods: {
    ...
    getRequests () {
      ...
      const headerKeys = Object.keys(this.headerSearchParams).filter(k => (this.headerSearchParams[k] && this.headerSearchParams[k].length !== 0));
      let headerFilters;
