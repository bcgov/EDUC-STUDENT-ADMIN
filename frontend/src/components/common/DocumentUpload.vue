    ...
    getFileRules() {
      ...
      this.fileRules = [
        ...
        value => {
          ...
          return !value?.length || this.fileRequirements.extensions.find(ext => ext.toUpperCase() === extension.toUpperCase()) !== undefined || this.fileRequirements.extensions.includes(value[0]?.type) || `File must be ${this.fileFormats}.`;
        }
      ];
