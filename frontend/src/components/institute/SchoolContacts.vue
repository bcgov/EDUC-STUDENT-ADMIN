    ...
    <template v-if="!loading">
      ...
      <v-row cols="2">
        ...
        <v-col class="d-flex justify-end">
          <PrimaryButton id="viewSchoolDetailsButton" class="mr-2" secondary icon-left icon="mdi-map-marker-outline" :to="`/institute/school/${schoolID}/details`" text="View School Details"></PrimaryButton>
