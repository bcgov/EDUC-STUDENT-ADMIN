<template>
  ...
  >
    ...
    <v-row class="py-1">
      ...
      >
        <span
          :class="{ 'diff-value': isValueEmpty(schoolHistory.authorityNumber, schoolHistory.authorityNumber_diff) }"
    ...
    <v-row class="py-1">
      ...
      >
        <span
          :class="{ 'diff-value': isValueEmpty(schoolHistory.displayNameNoSpecialChars, schoolHistory.displayNameNoSpecialChars_diff) }"
      ...
      >
        <span :class="{ 'diff-value': schoolHistory.displayNameNoSpecialChars_diff }">{{
          schoolHistory.displayNameNoSpecialChars
        }}</span>
      </v-col>
    </v-row>
    ...
    <v-row class="py-1">
      ...
      >
        <span :class="{ 'diff-value': schoolHistory.phoneNumber_diff }">{{
          formatPhoneNumber(schoolHistory.phoneNumber)
        }}</span>
      </v-col>
    </v-row>
    ...
    <v-row class="py-1">
      ...
      >
        <span :class="{ 'diff-value': schoolHistory.faxNumber_diff }">{{
          formatPhoneNumber(schoolHistory.faxNumber)
        }}</span>
      </v-col>
    </v-row>
    ...
    <v-row class="py-1">
      ...
      >
        <span :class="{ 'diff-value': schoolHistory.openedDate_diff }">{{
          formatDate(schoolHistory.openedDate)
        }}</span>
      </v-col>
    </v-row>
    ...
    <v-row class="py-1">
      ...
      >
        <span :class="{ 'diff-value': schoolHistory.closedDate_diff }">{{
          formatDate(schoolHistory.closedDate)
        }}</span>
      </v-col>
    </v-row>
    ...
    <v-row class="py-1">
      ...
      >
        <span
          :class="{ 'diff-value': isValueEmpty(schoolHistory.facilityTypeValue, schoolHistory.facilityTypeValue_diff) }"
        >Facility Type</span>
      </v-col>
      <v-col
        cols="6"
      ...
      >
        <span :class="{ 'diff-value': schoolHistory.facilityTypeValue_diff }">{{
          schoolHistory.facilityTypeValue
        }}</span>
      </v-col>
    </v-row>
    ...
    <v-row class="py-1">
      ...
      >
        <span
          :class="{ 'diff-value': isValueEmpty(schoolHistory.schoolCategoryValue, schoolHistory.schoolCategoryValue_diff) }"
      ...
      >
        <span :class="{ 'diff-value': schoolHistory.schoolCategoryValue_diff }">{{
          schoolHistory.schoolCategoryValue
        }}</span>
      </v-col>
    </v-row>
    ...
    <v-row class="py-1">
      ...
      >
        <span
          :class="{ 'diff-value': isValueEmpty(schoolHistory.schoolOrganizationValue, schoolHistory.schoolOrganizationValue_diff) }"
      ...
      >
        <span :class="{ 'diff-value': schoolHistory.schoolOrganizationValue_diff }">{{
          schoolHistory.schoolOrganizationValue
        }}</span>
      </v-col>
    </v-row>
    ...
    <v-row class="py-1">
      ...
      >
        <FormattedAddress
          v-if="schoolHistory.mailingAddress"
    ...
    <v-row class="py-1">
      ...
      >
        <span
          :class="{ 'diff-value': isValueEmpty(schoolHistory.physicalAddress, schoolHistory.physicalAddress_diff) }"
      ...
      >
        <FormattedAddress
          v-if="schoolHistory.physicalAddress"
