...
export default {
  ...
  methods: {
    ...
    async deleteStudent(){
      ...
      this.loadingCount += 1;
      this.hasError = false;
      ApiService.apiAxios.post(`${Routes.sdc.SDC_SCHOOL_COLLECTION_STUDENT}/${this.sdcSchoolCollectionStudentDetailCopy.sdcSchoolCollectionID}/students/remove`, this.selectedSdcStudentID)
        .then(() => {
