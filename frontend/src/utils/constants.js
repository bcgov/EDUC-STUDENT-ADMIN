 ...
 *  export const STUDENT_MERGE_FIELDS = {
       FROM_SUFFIX: 'mergeFrom_'    
    }; 
 **/
export const STUDENT_MERGE_FIELD_SUFFIX = 'mergeFrom_';
export const STUDENT_MERGE_DETAILS_FIELDS = Object.freeze(
  {
    LEGAL_LAST_NAME: `${STUDENT_MERGE_FIELD_SUFFIX}${STUDENT_DETAILS_FIELDS.LEGAL_LAST_NAME}`,
    LEGAL_FIRST_NAME: `${STUDENT_MERGE_FIELD_SUFFIX}${STUDENT_DETAILS_FIELDS.LEGAL_FIRST_NAME}`,
    LEGAL_MIDDLE_NAMES: `${STUDENT_MERGE_FIELD_SUFFIX}${STUDENT_DETAILS_FIELDS.LEGAL_MIDDLE_NAMES}`,
    USUAL_LAST_NAME: `${STUDENT_MERGE_FIELD_SUFFIX}${STUDENT_DETAILS_FIELDS.USUAL_LAST_NAME}`,
    USUAL_FIRST_NAME: `${STUDENT_MERGE_FIELD_SUFFIX}${STUDENT_DETAILS_FIELDS.USUAL_FIRST_NAME}`,
    USUAL_MIDDLE_NAMES: `${STUDENT_MERGE_FIELD_SUFFIX}${STUDENT_DETAILS_FIELDS.USUAL_MIDDLE_NAMES}`,
    GENDER_CODE: `${STUDENT_MERGE_FIELD_SUFFIX}${STUDENT_DETAILS_FIELDS.GENDER_CODE}`,
    DOB: `${STUDENT_MERGE_FIELD_SUFFIX}${STUDENT_DETAILS_FIELDS.DOB}`,
    MINCODE: `${STUDENT_MERGE_FIELD_SUFFIX}${STUDENT_DETAILS_FIELDS.MINCODE}`,
    LOCAL_ID: `${STUDENT_MERGE_FIELD_SUFFIX}${STUDENT_DETAILS_FIELDS.LOCAL_ID}`,
    POSTAL_CODE: `${STUDENT_MERGE_FIELD_SUFFIX}${STUDENT_DETAILS_FIELDS.POSTAL_CODE}`,
  }
);
