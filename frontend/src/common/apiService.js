...
export default {
  ...
  getMincodeSchoolNames: getCodes(Routes.institute.SCHOOL_DATA_URL),
  getActiveSchools: getCodes(`${Routes.institute.SCHOOL_DATA_URL}?active=true`),
  getActiveDistricts: getCodes(`${Routes.institute.DISTRICT_DATA_URL}?active=true`),
  getSchools:getCodes(Routes.institute.SCHOOL_DATA_URL),
  getDistricts:getCodes(Routes.institute.DISTRICT_DATA_URL),
  getAuthorities:getCodes(Routes.institute.AUTHORITY_DATA_URL),
  ...
  getSchoolOrganizationTypeCodes: getCodes(Routes.institute.SCHOOL_ORGANIZATION_TYPES_URL),
  getSchoolNeighborhoodLearningCodes: getCodes(Routes.institute.SCHOOL_NEIGHBORHOOD_LEARNING_TYPES_URL),
  getAuthorityTypeCodes: getCodes(Routes.institute.AUTHORITY_TYPES_URL),
  getInstituteGradeCodes: getCodes(Routes.institute.GRADE_TYPES_URL),
};
